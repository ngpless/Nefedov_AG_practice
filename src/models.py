# -*- coding: utf-8 -*-
"""
Классические модели рекомендаций.

Реализованы базовые эвристики (среднее, популярность), коллаборативная
фильтрация по пользователям и объектам, матричные разложения (SVD, NMF)
и гребневая регрессия. Все модели обучаются только на обучающей выборке;
предсказания ограничиваются диапазоном допустимых оценок.
"""
